    ...
    return (
        <div>
            ...
            <main className="flex w-screen h-screen">
                <div className="leftcolumn bg-gray-200 w-1/2 flex flex-col justify-center">
                    {loading && 
                ...
                <div className="rightcolumn bg-gray-100 w-1/2 pt-21">
                    <div className="rightcolumn_content flex flex-col items-start ml-20">
                        <div className="bg-white border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm w-150">
                            ...
                            <button onClick={SendDescription} className="bg-slate-100 stroke-slate-600 border border-slate-200 col-start-6 flex justify-center rounded-lg p-2 duration-300 hover:border-slate-600 hover:bg-amber-500 hover:stroke-white hover:text-white focus:stroke-white focus:bg-amber-500 w-20">
